...
export default function ProjectCard({
  ...
  return (
    ...
    >
      <div
        className="group relative block overflow-hidden rounded-[28px] border border-ink/12 bg-paper p-8 transition-all duration-500 ease-spring hover:-translate-y-1 hover:border-ink/25 sm:p-12"
      >
          ...
          <div className="relative mt-6 flex flex-wrap gap-3">
            {project.href && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-full bg-cobalt px-5 py-2.5 text-sm font-semibold text-paper transition-transform duration-300 hover:-translate-y-0.5"
            ...
            {project.sourceHref && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-full border border-ink/20 px-5 py-2.5 text-sm font-medium text-ink transition-colors duration-300 hover:bg-ink hover:text-paper"
                onClick={(e) => e.stopPropagation()}
              >
